...
def main():
    ...
    setup(
        name="ctodd-python-lib-os",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with Linux OS and CLI"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-os",
